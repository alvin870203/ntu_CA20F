...
// homework
    ...
    // reg [DATA_W-1:0] o_i_data_w, o_i_data_r;
    ...
    // assign o_i_valid_addr = 0;
/* 
    assign o_i_addr = o_i_addr_r;
    always @(*) begin
        if (InstNext)// && i_i_valid_inst)
...
*/
    // assign o_d_data = 0;
    // assign o_d_addr = 0;
    // assign o_d_MemRead = 0;
    // assign o_d_MemWrite = 0;
    // assign o_finish = 0;
    ...
    ProgCount #(
        ...
        .i_PC_next(PC_next),
        .i_InstNext(InstNext),
        .i_Branch_valid(Branch & Zero),
        .o_PC(PC)
        //.o_i_valid_addr(o_i_valid_addr)
    );
    

    assign o_i_addr = (Branch & Zero) ? PC_next : PC;
    assign o_i_valid_addr = InstNext;
